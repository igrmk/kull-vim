...
hi DiffAdd               ctermfg=16    ctermbg=108  cterm=nocombine      guifg=#000000 guibg=#90c08e gui=nocombine
hi DiffChange            ctermfg=231   ctermbg=240  cterm=nocombine      guifg=#ffffff guibg=#545557 gui=nocombine
hi DiffDelete            ctermfg=16    ctermbg=181  cterm=nocombine      guifg=#000000 guibg=#d6a29f gui=nocombine
hi DiffText              ctermfg=16    ctermbg=181  cterm=bold,nocombine guifg=#000000 guibg=#d6a29f gui=bold,nocombine
